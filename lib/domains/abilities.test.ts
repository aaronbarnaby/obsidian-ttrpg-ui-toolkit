...
import { DNDAbilityBlock, DNDAbilityScores, GenericBonus } from "../types";
...
`;
      ...
      const abilities = result.abilities as DNDAbilityScores;
      expect(abilities.strength).toBe(15);
      expect(abilities.dexterity).toBe(14);
      expect(abilities.constitution).toBe(13);
      expect(abilities.intelligence).toBe(12);
      expect(abilities.wisdom).toBe(10);
      expect(abilities.charisma).toBe(8);
    });
...
`;
      ...
      expect(result.type).toBe("dnd");
      const dndResult = result as DNDAbilityBlock;

      expect(dndResult.bonuses).toHaveLength(2);
      expect(dndResult.bonuses[0]).toEqual({
        name: "Racial Bonus",
        target: "strength",
        value: 2,
      });
      expect(dndResult.bonuses[1]).toEqual({
        name: "Magic Item",
        target: "dexterity",
        value: 1,
      });
...
`;
      ...
      expect(dndResult.proficiencies).toEqual(["Strength", "Constitution"]);
    });
...
`;
      ...
      expect(dndResult.abilities.strength).toBe(15);
      expect(dndResult.abilities.dexterity).toBe(0);
      expect(dndResult.bonuses).toEqual([]);
      expect(dndResult.proficiencies).toEqual([]);
    });
...
`;
      ...
      expect(dndResult.bonuses).toHaveLength(1);
      expect(dndResult.bonuses[0]).toEqual({
        name: "Legacy Bonus",
        target: "strength",
        value: 2,
      ...
      expect(dndResult.bonuses[0].modifies).toBeUndefined();
    });
  });
...
`,
      ...
      expect(dndResult.abilities.strength).toBe(15);
      expect(dndResult.abilities.dexterity).toBe(14);
    });
...
> \`\`\``,
      ...
      expect(dndResult.abilities.strength).toBe(15);
      expect(dndResult.abilities.dexterity).toBe(10);
    });
...
>>> \`\`\``,
      ...
      expect(dndResult.abilities.strength).toBe(8);
      expect(dndResult.abilities.dexterity).toBe(14);
      expect(dndResult.abilities.constitution).toBe(12);
    });
...
> \`\`\``,
      ...
      expect(dndResult.abilities.strength).toBe(10);
      expect(dndResult.abilities.charisma).toBe(16);
      expect(dndResult.bonuses).toHaveLength(1);
      expect(dndResult.bonuses[0].target).toBe("charisma");
      expect(dndResult.bonuses[0].value).toBe(2);
    });
...
> \`\`\``,
      ...
      expect(dndResult.abilities.strength).toBe(12);
      expect(dndResult.proficiencies).toContain("strength");
      expect(dndResult.proficiencies).toContain("constitution");
    });
