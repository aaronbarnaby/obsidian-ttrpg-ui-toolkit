...
export type TTRPGBlock = {
  type: 'dnd' | 'daggerheart';
}

export type DNDAbilityBlock = {
  type: 'dnd';
...
export type DaggerHeartAbilityBlock = {
  type: 'daggerheart';
  abilities: DaggerHeartAbilityScores;
}

export type AbilityBlock = DNDAbilityBlock | DaggerHeartAbilityBlock;

export type DNDAbilityScores = {
  strength: number;
  dexterity: number;
  constitution: number;
  intelligence: number;
...
export type DaggerHeartAbilityScores = {
  agility: number;
  strength: number;
  finesse: number;
  instinct: number;
...
export type GenericBonus = {
  name: string;
  target: keyof DNDAbilityScores | keyof DaggerHeartAbilityScores;
  value: number;
...
export type DaggerHeartAbility = {
  type: 'daggerheart';
  label: string;
  modifier: number;
  list: string[];
...
export type Ability = DNDAbility | DaggerHeartAbility;
